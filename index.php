...
<body>
    <header>
        <div class="nav container">
            <img src="https://scontent.furt2-1.fna.fbcdn.net/v/t1.15752-9/270242207_1008296189759019_4358413855295773765_n.png?_nc_cat=108&ccb=1-5&_nc_sid=ae9488&_nc_ohc=uyrLkkFBVJkAX8ztm-v&_nc_ht=scontent.furt2-1.fna&oh=03_AVJhJihfOtEQpdhPOa17f_Q_xBzcD-OzRscgIpoN7ePYBg&oe=61F48E5D"
                width="200px">
                <a class="nav-link" href="https://home-main2.herokuapp.com/" style="color: white; margin-left: 50%;  ">หน้าหลัก</a>
                <a class="nav-link" href="#" style="color: white; margin-left: 1%;">จองโต๊ะ</a>
                <i class='bx bx-shopping-bag' id="cart-icon" style="font-size: 1.5rem; " ></i>
    ...
    <section class="food container">
        ...
        <div class="food-content">
            <!--อาหาร1-->
            <div class="food-box">
                <img src="https://www.proudofficials.com/application/files/cache/thumbnails/11379623aad9ff6a00488535f149d32d.jpg"
                    alt="" class="food-img">
                <h2 class="food-title">ปูผัดผงกระหรี่</h2>
                <span class="cart-price">260 บาท</span>
            ...
            <div class="food-box">
                ...
                <span class="cart-price">160 บาท</span>
                <i class='bx bx-basket add-cart'></i>
            </div>
            <!--อาหาร3-->
            <div class="food-box">
                ...
                <span class="cart-price">100 บาท</span>
                <i class='bx bx-basket add-cart'></i>
            </div>
            <!--อาหาร4-->
            <div class="food-box">
                ...
                <span class="cart-price">60 บาท</span>
                <i class='bx bx-basket add-cart'></i>
            </div>
            <!--อาหาร5-->
            <div class="food-box">
                ...
                <span class="cart-price">10 บาท</span>
                <i class='bx bx-basket add-cart'></i>
            </div>
            <!--อาหาร6-->
            <div class="food-box">
                ...
                <span class="cart-price">120 บาท</span>
                <i class='bx bx-basket add-cart'></i>
            </div>
            <!--อาหาร7-->
            <div class="food-box">
                <img src="https://f4610.files.wordpress.com/2015/12/772.jpg?w=2500&h&fbclid=IwAR2_dtY-SjFGHRpgf76OilZrn_obe_nMiNBWQPRri20oI1J3xBv6M8SjKwA"
                    alt="" class="food-img">
            ...
            <div class="food-box">
                ...
                <span class="cart-price">600 บาท</span>
                <i class='bx bx-basket add-cart'></i>
            </div>
        </div>
    </section>
...
<script>
    ...
    function addCartclicked(event) {
        ...
        var price = shopfood.getElementsByClassName('cart-price')[0].innerText;
    ...
    function addfoodtocart(title, price, foodimg) {
        ...
        var cartitmesname = cartitmes.getElementsByClassName('cart-food-title');
        for (var i = 0; i < cartitmesname.length; i++) {
            alert("คุณได้เพื่มรายการอาหารแล้ว");
            return;
        }
    }
    var cartboxcontent = `
                        ...
                        <div class="detail">
                            <div class="cart-food-title">ปูผัดผงกระหรี่</div>
                            <div class="cart-price">260 บาท</div>
    ...
    function updatetotal() {
        var cartcontent = document.getElementsByClassName('food-content')[0];
        var cartboxs = cartcontent.getElementsByClassName('food-box');
        var total = 0;
